...
const WIDEVINE_SID = hexToBytes("edef8ba979d64acea3c827dcd51d21ed");
...
export class PSSH {
    ...
    get decoded(): pywidevine_license_protocol.WidevinePsshData | null {
        if(equalBytes(this.systemId, WIDEVINE_SID)) return pywidevine_license_protocol.WidevinePsshData.deserialize(this.initData);
        else return null;
    }
