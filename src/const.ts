import { LicenseKeyContainerKeyType, LicenseType as LicenseType_ } from "@li0ard/widevineproto";
...
/** Key type */
export const KeyType = LicenseKeyContainerKeyType;
/** License type */
export const LicenseType = LicenseType_;
